...
// #defines for the GSM 6.10 codec
#define PVWAVGSM_SAMPLES_PER_PCMFRAME   160
#define PVWAVGSM_BYTES_PER_PCMFRAME     320
#define PVWAVGSM_BYTES_PER_GSMFRAMEPAIR 65
#define PVWAVGSM_BYTES_PER_GSMFRAME     33 //32.5
#define PVWAVGSM_BYTES_PER_SAMPLE       2
...
class PV_Wav_Parser
{
    ...
    private:
        ...
        void  *iGsmHandle; // Pointer to struct gsm, the codec handle
        uint8 iHalfFrame[PVWAVGSM_BYTES_PER_PCMFRAME];
        int iPrevData;
};
