...
// Constructor
PVA_FF_QcelpSampleEntry::PVA_FF_QcelpSampleEntry(int32 codecType)
        : PVA_FF_SampleEntry(FourCharConstToUint32('s', 'q', 'c', 'p'))
{
    PV_MP4_FF_NEW(fp->auditCB, PVA_FF_QcelpAtom, (MEDIA_TYPE_AUDIO, codecType), _pes);
...
PVA_FF_QcelpSampleEntry::~PVA_FF_QcelpSampleEntry()
{
    ...
    PV_MP4_FF_DELETE(NULL, PVA_FF_QcelpAtom, _pes);
}
