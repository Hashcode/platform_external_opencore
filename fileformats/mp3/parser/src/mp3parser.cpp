 ...
 * SIDE EFFECTS:
 ***********************************************************************/
MP3ErrorType  MP3Parser::SeekToTimestamp(uint32 timestampInMsec, uint32& actualTimestamp)
{
    ...
    // BEGIN Motorola, e5568c, 2010-05-12, IKMAP-9358, return an error code if failed
    MP3ErrorType ret = MP3Utils::SeektoOffset(fp, SeekPosition, Oscl_File::SEEKSET);
    actualTimestamp = timestampInMsec;
    return ret;
    // END IKMAP-9358
}
