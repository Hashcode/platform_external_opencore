...
#define NUMBER_OUTPUT_BUFFER 20 
...
//  OSCL_IMPORT_REF bool queryInterface(const PVUuid& uuid, PVInterface*& iface);
        ...
        PVMFStatus SetInputTimescale(uint32 timescale);
...
//Shashank's Modification Starts
		bool iIsFlushSentToOMXComponent;
		bool iIsTI720PComponent;
