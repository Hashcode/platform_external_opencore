...
#ifndef ANDROID_AUDIO_RAW_H
#define ANDROID_AUDIO_RAW_H
...
class AndroidAudioRawOutput : public AndroidAudioMIO
{
public:
    OSCL_IMPORT_REF AndroidAudioRawOutput();
    OSCL_IMPORT_REF ~AndroidAudioRawOutput();
