...
/* Motorola Nixon: The defination is specific to Sholes need to change for Ruth. A generic definition should be used */
#ifdef PV_ANDROID
...
private:
    ...
    int32                   mFlags;
    VideoEncodingMode       iVideoMode;
    int64_t                 iVideoModeSpeed;
